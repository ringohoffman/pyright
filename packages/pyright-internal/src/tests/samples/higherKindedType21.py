# This sample tests PEP 695 higher-kinded classmethod constructor specialization (dict.fromkeys pattern).
...
reveal_type(from_int_keys2, expected_text="_dict2[int, Any | None]")
from_int_keys_with_value2 = _dict2.fromkeys(list(range(10)), "food")
reveal_type(from_int_keys_with_value2, expected_text="_dict2[int, str]")

ordered_from_int_keys2 = _OrderedDict2.fromkeys(list(range(10)))
reveal_type(ordered_from_int_keys2, expected_text="_OrderedDict2[int, Any | None]")
ordered_from_int_keys_with_value2 = _OrderedDict2.fromkeys(list(range(10)), "food")
reveal_type(ordered_from_int_keys_with_value2, expected_text="_OrderedDict2[int, str]")
...
reveal_type(f({1: 1}), expected_text="dict[int, int]")

reveal_type(f(collections.OrderedDict({1: 1})), expected_text="OrderedDict[int, int]")
